...
- **Eintrittswahrscheinlichkeit**: Mittel (Wir sind diese Woche etwas knapper dran als sonst, also besteht diese Eintrittswahrscheinlichkeit durchaus, aber wenn sich alle mühe geben wird dies nicht zu einem Problem)
- **Gewichtung**: Hoch: Würde dazu führen, dass die Demo und das Testkonzept unfertig oder mit mangelnder Qualität fertiggestellt wird.
- **Gegenmassnahmen beim Eintreten des Ereignisses**: Die Version präsentieren, welche vollständig ist und danach die verspäteten Issues aufholen. Das Testkonzept mit dem momentanen stand fertigstellen. 
